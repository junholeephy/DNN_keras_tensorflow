...
LOAD_MODEL_WEIGHTS = 'self_models_GEN/1_Gen_BjetTopHad_E/starter1_kin_model_weights_EN260000_LN1_E1000_NN50_B500_adam_LR1e-05_DR0.0.h5' 	#KIN
###############################################################################################################
...
for j1 in range(reco_bj1_Energy.size):
	...
	mHT[j1]			= mHT_[jj1]
	TARGET[j1]      = Gen_BjetTopHad_E_[jj1]
...
if(MEM==True):
	np.savetxt("self_loss_values_GEN/1_Gen_BjetTopHad_E/loss_MEM_EN"+str(upper_limit)+"_LN"+str(ijkl)+"_E"+str(EPOCHS)+"_NN"+str(NODENUM)+"_B"+str(BATCH_SIZE_train)+"_"+str(OPTIMIZER)+"_L"+str(L2)+"_DR"+str(DROP_RATE)+".txt", new_loss_history, delimiter=" ")
else:
	np.savetxt("self_loss_values_GEN/1_Gen_BjetTopHad_E/loss_KIN_EN"+str(upper_limit)+"_LN"+str(ijkl)+"_E"+str(EPOCHS)+"_NN"+str(NODENUM)+"_B"+str(BATCH_SIZE_train)+"_"+str(OPTIMIZER)+"_L"+str(L2)+"_DR"+str(DROP_RATE)+".txt", new_loss_history, delimiter=" ")
...
if(MEM==True):
	modelRegress.save_weights('self_models_GEN/1_Gen_BjetTopHad_E/mem_model_weights_EN'+str(upper_limit)+"_LN"+str(ijkl)+"_E"+str(EPOCHS)+"_NN"+str(NODENUM)+"_B"+str(BATCH_SIZE_train)+"_"+str(OPTIMIZER)+"_L"+str(L2)+"_DR"+str(DROP_RATE)+'.h5')
else:
	modelRegress.save_weights('self_models_GEN/1_Gen_BjetTopHad_E/kin_model_weights_EN'+str(upper_limit)+"_LN"+str(ijkl)+"_E"+str(EPOCHS)+"_NN"+str(NODENUM)+"_B"+str(BATCH_SIZE_train)+"_"+str(OPTIMIZER)+"_L"+str(L2)+"_DR"+str(DROP_RATE)+'.h5')


if(MEM==True):
	f = TFile("self_trees_GEN/1_Gen_BjetTopHad_E/self_tree_mem_EN"+str(upper_limit)+"_LN"+str(ijkl)+"_E"+str(EPOCHS)+"_NN"+str(NODENUM)+"_B"+str(BATCH_SIZE_train)+"_"+str(OPTIMIZER)+"_L"+str(L2)+"_DR"+str(DROP_RATE)+".root", "recreate")
else:
	f = TFile("self_trees_GEN/1_Gen_BjetTopHad_E/self_tree_kin_EN"+str(upper_limit)+"_LN"+str(ijkl)+"_E"+str(EPOCHS)+"_NN"+str(NODENUM)+"_B"+str(BATCH_SIZE_train)+"_"+str(OPTIMIZER)+"_L"+str(L2)+"_DR"+str(DROP_RATE)+".root", "recreate")
