...
modelRegress.fit(data_train, target_train, validation_data=(data_test, target_test), epochs=10, batch_size=500)
...
tree_Ttrain = TTree('tree_Ttrain','tree_Ttrain')
tree_Ttrain.Branch('tTrain',tTrain,'tTrain/F')
for i in range()

tree_Otrain = TTree('tree_Otrain','tree_Otrain')
