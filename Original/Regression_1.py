...
#modelRegress.load_weights('my_model_weights.h5',by_name=True)    #load formerly saved weights and do regression
...
#modelRegress.save('my_model.h5')
modelRegress.save_weights('my_model_weights.h5')				#save current weights
